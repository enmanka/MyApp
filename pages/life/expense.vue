	...
	export default {
		data() {
			return {
				...
				circles: [
				            {category: "饮食", selected: false },
				            {category: "出行", selected: false },
				            {category: "服饰", selected: false },
				            {category: "购物", selected: false },
				            {category: "教育", selected: false },
				            {category: "娱乐", selected: false },
				            {category: "生活缴费", selected: false },
				            {category: "医疗", selected: false },
				            {category: "保险", selected: false },
				            {category: "投资", selected: false },
				            {category: "转账", selected: false },
