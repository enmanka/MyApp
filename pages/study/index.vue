<template>
	<div class="studyHomepage">
		<div class="studyContent">
			<div class="modules">
				<div class="module timetable" @click="navigateTo('timetable')">
					<h2>课表查询</h2>
				...
				<div class="module remember" @click="navigateTo('remember')">
					<h2>备忘录</h2>
					<p>记录你的备忘信息</p>
				</div>
				<div class="module notes" @click="navigateTo('notes')">
					<h2>课堂笔记</h2>
					<p>记录你的课堂笔记</p>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			navigateTo(page) {
				const pageMap = {
					timetable: '/pages/study/timetable',
					remember: '/pages/study/remember',
					notes: '/pages/study/notes',
				};
				uni.navigateTo({
					url: pageMap[page]
				});
		...
		// mounted() {
		// 	this.selectedIcon = 'study';
		// },
		onShow() {
			this.selectedIcon = 'study';
			uni.setStorageSync('selectedIcon', 'study');
		},
	}
</script>
